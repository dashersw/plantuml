...
public class ComponentBlueModernGroupingHeader extends AbstractTextualComponent {
	...
	public ComponentBlueModernGroupingHeader(Color headerBackgroundColor, Color generalBackgroundColor,
			Color borderColor, Color fontColor1, Color fontColor2, Font bigFont, Font smallFont, List<String> strings) {
		super(strings.get(0), fontColor1, bigFont, 15, 30, 1);
		...
		if (strings.size() == 1 || strings.get(1) == null) {
			...
			this.commentTextBlock = new TextBlock(Arrays.asList("[" + strings.get(1) + "]"), smallFont, fontColor2);
		}
	}

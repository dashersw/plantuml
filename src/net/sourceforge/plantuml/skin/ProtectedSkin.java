...
public class ProtectedSkin implements Skin {
	...
	public Component createComponent(ComponentType type, List<? extends CharSequence> stringsToDisplay) {
		Component result = null;
		try {
			result = skinToProtect.createComponent(type, stringsToDisplay);
		} catch (Throwable e) {
			e.printStackTrace();
		}
		if (result == null) {

...
public class ComponentRoseGroupingHeader extends AbstractTextualComponent {
	...
	public ComponentRoseGroupingHeader(Color fontColor, Font bigFont, Font smallFont, List<String> strings) {
		super(strings.get(0), fontColor, bigFont, 15, 30, 1);
		if (strings.size() == 1 || strings.get(1) == null) {
			this.commentTextBlock = null;
		} else {
			this.commentTextBlock = new TextBlock(Arrays.asList("[" + strings.get(1) + "]"), smallFont, fontColor);
		}
	}

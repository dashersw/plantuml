...
public abstract class AbstractComponentRoseArrow extends AbstractTextualComponent implements ArrowComponent {
	...
	public AbstractComponentRoseArrow(Color foregroundColor, Color fontColor, Font font, List<String> stringsToDisplay, boolean dotted) {
		super(stringsToDisplay, fontColor, font, 7, 7, 2);
		this.dotted = dotted;

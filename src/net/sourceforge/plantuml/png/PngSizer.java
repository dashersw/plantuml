...
public class PngSizer {
	...
	static public BufferedImage process(BufferedImage im, int minsize) throws IOException {
	...
	static private BufferedImage resize(BufferedImage im, int minsize) throws IOException {

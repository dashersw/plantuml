...
public class PngError {
	...
	public void writeError(OutputStream os) throws IOException {
	...
	public Dimension2D draw(final Graphics2D g2d) {
		final TextBlock textBlock = TextBlockUtils.create(strings, FONT1, green, HorizontalAlignement.LEFT);

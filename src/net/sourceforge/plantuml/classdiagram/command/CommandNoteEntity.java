...
public class CommandNoteEntity extends SingleLineCommand<AbstractEntityDiagram> {
	...
	protected boolean executeArg(List<String> arg) {
		...
		final Entity note = getSystem().createEntity("GN" + cpt, arg.get(2), EntityType.NOTE);
		cpt++;

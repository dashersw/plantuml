...
class TextBlockWithNumber extends TextBlockSimple {
	...
	public TextBlockWithNumber(int num, List<? extends CharSequence> texts, Font font, Color paint,
			HorizontalAlignement horizontalAlignement) {
		super(texts, font, paint, horizontalAlignement);
		this.numText = TextBlockUtils.create(Arrays.asList("" + num), font.deriveFont(Font.BOLD), paint,

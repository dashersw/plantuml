...
public class SequenceDiagramPngMaker2 {
	...
	public SequenceDiagramPngMaker2(SequenceDiagram sequenceDiagram) {
		this.initializer = new DrawableSetInitializer(sequenceDiagram.getSkin(), true);
	...
	public void draw(Graphics2D g2d) throws IOException {
		if (fullDimension == null) {
			...
			if (drawableSet.getComponentTitle() != null) {
				titleHeight = drawableSet.getComponentTitle().getPreferredHeight(g2d);
			}
		...
		drawableSet.draw(g2d, 0, (int) fullDimension.getWidth(), (int) fullDimension.getHeight(), pages.get(0), true,
				true);
	}

...
public class CommandArrow extends SingleLineCommand<SequenceDiagram> {
	...
	protected boolean executeArg(List<String> arg) {
		...
		final String arrow = StringUtils.manageArrow(arg.get(1));
		...
		final boolean dotted = arrow.length() == 3;
		...
		getSystem().addMessage(new Message(p1, p2, labels, dotted, getSystem().getNextMessageNumber()));
		return true;
	}

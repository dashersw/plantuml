...
public class CommandLinkActivity extends SingleLineCommand<ActivityDiagram> {
	...
	protected boolean executeArg(List<String> arg) {
		...
		final EntityType type2 = getTypeFromString(arg.get(5), EntityType.CIRCLE_END);

		final Entity entity1 = getSystem().getOrCreate(arg.get(1), type1);
		final Entity entity2 = getSystem().getOrCreate(arg.get(6), type2);

		if (entity1 == null || entity2 == null) {
			return false;
		}

		final String label1 = arg.get(4);
		...
		final int lenght = arg.get(3).length();
